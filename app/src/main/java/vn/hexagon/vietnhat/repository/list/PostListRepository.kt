...
import vn.hexagon.vietnhat.data.model.fone.PhoneGiftResponse
...
class PostListRepository @Inject constructor(private val apiService: NetworkService) {
    ...
    fun getPostList(
        ...
        return apiService.getPostList(userId, serviceId, index, number,lat, lng)
    }
     ...
     * @param number
     */
    fun getFoneHouse(index: Int, number: Int): Single<ListFoneHouseResponse> {
        return apiService.getPhoneHouse(index, number)
    }
    ...
    fun searchPhoneHouse(
        ...
        return apiService.searchPhoneHouse(modelID, brandID, 0, numberPost)
    }
    ...
    fun getPhoneGift(
        ...
        return apiService.getPhoneGift(index, numberPost)
    }
    ...
    */
    ...
    fun getFilterPhone(brandID: String, typeID: String,index: Int,number: Int): Single<ListFoneHouseResponse> {
        return apiService.getPhoneHouseSearch(brandID, typeID,index, number)
    }

    fun removeFavouriteGift(userId: String, giftID: String): Single<ListPostResponse> {
        return apiService.removeFavouriteGift(userId, giftID)
    }

    fun addFavouriteGift(userId: String, giftID: String): Single<ListPostResponse> {
        return apiService.getFavouriteGift(userId, giftID)
    }
