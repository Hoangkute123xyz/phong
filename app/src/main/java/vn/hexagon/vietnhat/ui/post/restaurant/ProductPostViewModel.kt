 ...
 */
class ProductPostViewModel @Inject constructor(private val repository: PostCreateRepository) :
    MVVMBaseViewModel() {
    ...
    fun sendDataPost(
        ...
        params.apply {
            ...
            latLng?.let {
                put("lat",requestBody(it.latitude.toString()))
                put("lng",requestBody(it.longitude.toString()))
            }
        }
