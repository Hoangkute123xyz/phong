package vn.hexagon.vietnhat.ui.social
...
import kotlinx.android.synthetic.main.action_bar_simple_text.*
...
import vn.hexagon.vietnhat.databinding.FragmentChatSocialBinding
import vn.hexagon.vietnhat.ui.chat.ChatDetailFragmentArgs
 ...
 */
class SocialDetailFragment : MVVMBaseFragment<FragmentChatSocialBinding, ChatDetailViewModel>() {
  ...
  private val userAvatar: String? by lazy {
    preferences.getString(
      getString(vn.hexagon.vietnhat.R.string.variable_local_avt),
      Constant.BLANK
    )
  }
  ...
  override fun isShowActionBar(): View? = SimpleActionBar(activity).apply {
    simpleTitleText = getString(R.string.social_detail)
  ...
  override fun getLayoutId(): Int = vn.hexagon.vietnhat.R.layout.fragment_chat_social
...
//          chatDetailRecycler.smoothSnapToPosition(position)
  ...
  override fun initView() {
    ...
    chatDetailRecycler.apply {
      ...
      chatAdapter = ChatDetailAdapter(userId!!,userAvatar!!)
      adapter = chatAdapter
