...
class SettingAdapter(private val context: Context,
                     ...
                     private val onClick: (Int) -> Unit) : RecyclerView.Adapter<SettingAdapter.GridMenuViewHolder>() {

    /**
     * Create View Holder
     */
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): GridMenuViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.item_setting_adapter, parent, false)
...
//        }
    ...
    class GridMenuViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        val menuTitle: TextView = itemView.findViewById(R.id.setting_grid_menu_title)
        val menuIcon: ImageView = itemView.findViewById(R.id.setting_grid_menu_icon)
