...
import kotlinx.android.synthetic.main.fragment_post_translate.martProductPlaceHoldItem
...
class TransPostFragment : MVVMBaseFragment<FragmentPostTranslateBinding, TransPostViewModel>(),
    View.OnClickListener, OnDialogClickListener, PhotoSelectListener, OnDialogClickWithData,
    ...
    override fun getBaseViewModel(): TransPostViewModel {
        transPostViewModel =
            ViewModelProviders.of(this, viewModelFactory)[TransPostViewModel::class.java]
...
//            )
        ...
        transPostViewModel.productPostResponse.observe(this, Observer { response ->
...
//    }
    ...
    private fun processSendDataPost() {
        ...
        val arrayFields = arrayOf<EditText>(
            postTransEdTitle,
            postTransEdAddress, /*postTransEdPrice,*/
            postTransEdPhone,
            postTransEdContent,
            postTransEdNote
        )
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        when (requestCode) {
            Constant.REQUEST_CD_PLACE -> mPlaces?.receivedAddressProcess(
                resultCode,
                data,
                postTransEdAddress
            )
    ...
    private fun ProductPostAdapter.processRemoveItem(position: Int) {
        ...
        this.apply {
            ...
            Handler().postDelayed({
                transItemRecyclerView.invalidateItemDecorations()
            }, 500)
        }
        transPostParent.layoutTransition
        Snackbar.make(
            transPostParent,
