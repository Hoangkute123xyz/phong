...
//    const val BASE_SERVER_URL = "https://api.themoviedb.org/3/"
    ...
    const val SOCKET_EVENT_SEND_MESSAGE_GROUP ="vnj_send_chat_group"
    const val SOCKET_EVENT_SEND_MESSAGE_COMM ="vnj_send_chat_community"
    const val SOCKET_EVENT_RECEIVE_MESSAGE ="vnj_chat"
    const val SOCKET_EVENT_RECEIVE_MESSAGE_GROUP ="vnj_chat_group"
    const val SOCKET_EVENT_RECEIVE_MESSAGE_COMM ="vnj_chat_community"
