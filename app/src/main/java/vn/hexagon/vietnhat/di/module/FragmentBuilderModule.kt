...
import vn.hexagon.vietnhat.ui.chat.add.AddGroupFragment
import vn.hexagon.vietnhat.ui.chat.community.CommunityDetailFragment
import vn.hexagon.vietnhat.ui.comment.CommentFragment
import vn.hexagon.vietnhat.ui.comment.PhoneGiftCommentFragment
import vn.hexagon.vietnhat.ui.detail.FoneGiftDetailFragment
...
import vn.hexagon.vietnhat.ui.list.fonegift.FoneGiftListFragment
...
import vn.hexagon.vietnhat.ui.list.phone.*
...
import vn.hexagon.vietnhat.ui.social.SocialDetailFragment
...
abstract class FragmentBuilderModule {
    ...
    @ContributesAndroidInjector
    abstract fun contributeFoneGiftFragment(): FoneGiftListFragment

    @ContributesAndroidInjector
    abstract fun contributeFoneGiftDetailFragment(): FoneGiftDetailFragment

    @ContributesAndroidInjector
    abstract fun contributeSocialDetailFragment(): SocialDetailFragment

    @ContributesAndroidInjector
    abstract fun contributeGuaranteeFragment(): GuaranteeListFragment

    @ContributesAndroidInjector
    abstract fun contributeFoneHomeFragment(): FoneHomeFragment

    @ContributesAndroidInjector
    abstract fun contributeFoneHouseDetailFragment(): FoneHouseDetailFragment

    @ContributesAndroidInjector
    abstract fun contributeFoneSearchFragment(): FoneSearchFragment

    @ContributesAndroidInjector
    abstract fun contributePhoneGiftCommentFragment(): PhoneGiftCommentFragment

    @ContributesAndroidInjector
    abstract fun contributeOrderPhoneFragment(): OrderPhoneFragment
