...
import vn.hexagon.vietnhat.ui.chat.add.AddGroupViewModel
import vn.hexagon.vietnhat.ui.chat.community.CommunityDetailViewModel
...
import vn.hexagon.vietnhat.ui.list.phone.FoneSearchViewModel
...
import vn.hexagon.vietnhat.ui.setting.SettingViewModel
...
abstract class ViewModelModule {
    ...
    @Binds
    @IntoMap
    @ViewModelKey(FonePlaceViewModel::class)
    abstract fun bindFonePlaceViewModel(fonePlaceViewModel: FonePlaceViewModel): ViewModel
    ...
    @Binds
    @IntoMap
    @ViewModelKey(FoneHouseDetailViewModel::class)
    abstract fun bindFoneHouseDetailViewModel(foneHouseDetailViewModel: FoneHouseDetailViewModel): ViewModel

    @Binds
    @IntoMap
    @ViewModelKey(FoneSearchViewModel::class)
    abstract fun bindFoneSearchViewModel(foneSearchViewModel: FoneSearchViewModel): ViewModel

    @Binds
    @IntoMap
    @ViewModelKey(PhoneGiftViewModel::class)
    abstract fun bindPhoneGiftViewModel(phoneGiftViewModel: PhoneGiftViewModel): ViewModel
    ...
    abstract fun bindAddGroupViewModel(addGroupViewModel: AddGroupViewModel): ViewModel

    @Binds
    @IntoMap
    @ViewModelKey(CommunityDetailViewModel::class)
    abstract fun bindCommunityDetailViewModel(communityDetailViewModel: CommunityDetailViewModel): ViewModel
